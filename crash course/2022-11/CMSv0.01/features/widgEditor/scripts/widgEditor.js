...
var widgStylesheet = "features/widgEditor/css/widgContent.css";
...
function writeFile() {
	var elHtml = 	document.getElementById('noiseWidgIframe').contentDocument.getElementById('iframeBody').innerHTML;
...
function readFile(event){
	...
	reader.addEventListener('load', (event) => {
		// this.writeDocument(event.target.result);
		var theIframe = document.getElementById('noiseWidgIframe');
		theIframe.contentWindow.document.open();
		theIframe.contentWindow.document.write(event.target.result);
		theIframe.contentWindow.document.close();
		// document.getElementById('noiseWidgIframe').contentDocument.getElementById('iframeBody').write(event.target.result);
	});
